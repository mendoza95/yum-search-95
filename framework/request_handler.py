...
class YumSearchRequestHandler(RequestHandler):
    ...
    """Recibe el template a renderizar y los argumentos que utiliza"""
    def render(self, template, **kwargs):
        jinja_template = self.jinja_enviroment.get_template(template)#obtenemos el template
        html_from_template = jinja_template.render(kwargs)#renderizamos con los argumentos
